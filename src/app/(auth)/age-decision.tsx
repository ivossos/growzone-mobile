        ...
        <View className="bg-black-100 w-full flex items-center justify-center h-full px-6">
          <View className="flex items-center justify-center gap-6 my-10">
            ...
            <View className="flex gap-2">
              ...
              <Text className="text-lg font-regular text-black-30 text-center ">
                Confirmo que tenho 18 anos ou mais e que concordo com os termos
          ...
          <View className="flex flex-col gap-4 w-full">
            ...
            <Text className="text-base font-regular text-black-30 text-center">
              A Growzone exige que você atenda os requisitos legais de idade
              para visualizar os conteúdos da nossa plataforma.
            </Text>
          </View>
        </View>
      </SafeAreaView>
