...
import HeaderOverlay from "@/components/ui/profile/header-overlay";
...
const Profile: React.FC = () => {
  ...
  // const { id } = (route.params as { id: number, openReview: string }) || {}
  ...
  const renderPosts = useCallback(
    ...
    [id, postRef, postScrollHandler, sharedProps]
  );
